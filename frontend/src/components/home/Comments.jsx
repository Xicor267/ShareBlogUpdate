    ...
    return (
        <>
                    ...
                    comment.length > 0 ? comment.map((c, index) => <div className="main-reply-comment">
                        <div className="image-comment-time-name">
                            ...
                            <div className="name-time-comment">
                                ...
                                {
                                    c.replyComment.length > 0 && c.replyComment.map((rc, index) => <div key = {index} className="reply_comment">
                                        <div className="reply_comment_image_name_time">
                                            <img src={rc.replyImage} alt="" />
                                            <div className="name-time-comment">
                                                <div className="name-time">
                                                    <h4>{rc.replyName}</h4>
                                                    <span>{moment(rc.createdAt).fromNow()}</span>
                                                </div>
                                                <p>{rc.replyText}</p> 
                                        ...
                                        {/* Delete reply cmt by ADMIN or SUB ADMIN */}
                                        {
            ...
            <div className="comment_submit">
                ...
                {
                    userInfo &&userInfo.role === 'admin' || userInfo.role === 'user' ? <form>

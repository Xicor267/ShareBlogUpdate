    ...
    return (
        <div className="article-details">
                ...
                <div className="like-dislike">
                    <div className="dislike">

                        {
                            ...
                            <button onClick={article_dislike} className={dislike_status === 'dislike' ? 'icon red' : 'icon'} ><AiFillDislike /></button> 
                    ...
                    <div className="like">
                        ...
                        {
                            userInfo && userInfo.role === 'user' ?
                            <button onClick={article_like} className={like_status === 'like' ? 'icon blue' : 'icon'} ><AiFillLike /></button> 
            ...
            <div className="social-icons">
                <a className='l1' href="https://www.facebook.com/trangnguyer/"><FaFacebookSquare /></a>
                <a className='l2' href=""><FaTwitterSquare /></a>
                <a className='l3' href="https://github.com/Xicor267"><FaGithubSquare /></a>
                <a className='l4' href="https://www.linkedin.com/in/nguyen-nam-4743b6229/"><ImLinkedin /></a>
            </div>
